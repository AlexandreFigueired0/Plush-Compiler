...
while_body11:
	...
	%arr_idx_28 = getelementptr i32, i32* %tmp_26, i32 %tmp_27
	%tmp_29 = load i32, i32* %arr_idx_28
...
if_end33:
	...
	%arr_idx_36 = getelementptr i32, i32* %tmp_34, i32 %tmp_35
	%tmp_37 = load i32, i32* %arr_idx_36
...
define void @main() {
	...
	%get_int_array_51 = call i32* @get_int_array( i32  %tmp_50 )
	store i32* %get_int_array_51, i32** %my_array49
	%i52 = alloca i32
	store i32 0, i32* %i52
...
while_body54:
	...
	%my_array_idx_61 = getelementptr i32, i32* %tmp_59, i32 %tmp_60
	%tmp_62 = load i32, i32* %my_array_idx_61
	%tmp_63 = load i32, i32* %i52
	store i32 %tmp_63, i32* %my_array_idx_61
...
while_end55:
	...
	%binary_search_67 = call i1 @binary_search( i32*  %tmp_66, i32  91 )
	call void @print_boolean( i1  %binary_search_67 )
	ret void
}